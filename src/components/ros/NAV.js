...
NAV.ImageMapClientNav = function (a) {
    var b = this;
    a = a || {};
    this.ros = a.ros;
...
NAV.Navigator = function (a) {
    function b(a) {
        ...
        d.x = a.position.x, d.y = -a.position.y, d.rotation = h.rosQuaternionToGlobalTheta(a.orientation), d.scaleX = 1 / h.scaleX, d.scaleY = 1 / h.scaleY, c.rootObject.addChild(d), b.on("result", function () {
                ...
                if ("down" === d) {
                    ...
                    if (c.rootObject.removeChild(q), r === !0) {
                        ...
                        q = new ROS2D.NavigationArrow({
                            ...
                            pulse: !1
                        }), s = f.x - n.x, t = f.y - n.y, o = Math.atan2(s, t), p = o * (180 / Math.PI), p >= 0 && 180 >= p ? p += 270 : p -= 90, q.x = n.x, q.y = -n.y, q.rotation = p, q.scaleX = 1 / h.scaleX, q.scaleY = 1 / h.scaleY, c.rootObject.addChild(q)
                    }
                } else if (r) {
                    r = !1;
                    var g = h.globalToRos(a.stageX, a.stageY),
                        i = new ROSLIB.Vector3(g);
                    s = i.x - n.x, t = i.y - n.y, o = Math.atan2(s, t), o >= 0 && o <= Math.PI ? o += 3 * Math.PI / 2 : o -= Math.PI / 2;
                    var j = Math.sin(-o / 2),
                        k = Math.cos(-o / 2),
...
NAV.OccupancyGridClientNav = function (a) {
    var b = this;
    a = a || {}, this.ros = a.ros;
    var c = a.topic || "/map",
        d = a.continuous;
    this.serverName = a.serverName || "/move_base", this.actionName = a.actionName || "move_base_msgs/MoveBaseAction", this.rootObject = a.rootObject || new createjs.Container, this.viewer = a.viewer, this.withOrientation = a.withOrientation || !1, this.navigator = null;
    ...
    e.on("change", function () {
        b.navigator = new NAV.Navigator({
            ...
            rootObject: b.rootObject,
            withOrientation: b.withOrientation
        }), b.viewer.scaleToDimensions(e.currentGrid.width, e.currentGrid.height), b.viewer.shift(e.currentGrid.pose.position.x, e.currentGrid.pose.position.y)
    })
};
export default NAV